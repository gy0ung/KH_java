...
import collection.map.Snack;

public class Properties1 {

	public static void main(String[] args) {
		// properties : Map계열 컬렉션 → key + value 세트로 저장
		// HashMap과의 차이점 : properties는 반드시 키값도 String, value값도 String이어야 됨
		...
		// properties를 사용하는 경우는 주로 파일로 출력 또는 입력을 받아 올 때 사용한다.
		// 즉, store(), load() 메소드 사용
		
		// 파일로 내보내기              // 파일이름.확장자명       // ↓ 파일에 대한 설명
		...
		*/
		...
		// properties를 파일로 내보내기를 하려면 String, String이어야한다.
		// 1. setProperties(String key, String value)
		prop.setProperty("List", "ArrayList");
		prop.setProperty("Set", "HashSet");
		prop.setProperty("Hello", "HashMap");
